...
class EngineServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AnalyzeVideo = channel.unary_unary(
                '/engine.EngineService/AnalyzeVideo',
                request_serializer=engine__pb2.AnalyzeVideoRequest.SerializeToString,
                response_deserializer=engine__pb2.AnalyzeVideoResponse.FromString,
...
def add_EngineServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AnalyzeVideo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=engine__pb2.AnalyzeVideoRequest.FromString,
                    response_serializer=engine__pb2.AnalyzeVideoResponse.SerializeToString,
            ),
    }
...
class EngineService(object):
    ...
    def AnalyzeVideo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/engine.EngineService/AnalyzeVideo',
            engine__pb2.AnalyzeVideoRequest.SerializeToString,
            engine__pb2.AnalyzeVideoResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
